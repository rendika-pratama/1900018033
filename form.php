...
<html>
<head>
	<title>Handling & Validasi Form</title>
</head>
<body>
	<center><h2>Handling & Validasi Form</h2></center>
	<?php 
		if (isset($_GET['submit'])) {
			...
			if (!empty($name) and !empty($NIM)) {
				...
				echo "Masukkan Data Dengan Benar <br>";
			}
			...
			$tambahan = $_GET['data_tambahan'];
			if (!empty($tambahan)) {
				echo "Tambahan : ".$tambahan."<br>";
			} else {
				echo " ";
			}
